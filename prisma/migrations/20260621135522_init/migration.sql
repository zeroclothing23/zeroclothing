...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PROCESSING', 'PRINTING', 'PACKED', 'SHIPPED', 'DELIVERED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "CustomRequestStatus" AS ENUM ('NEW', 'REVIEWING', 'QUOTED', 'ACCEPTED', 'REJECTED', 'COMPLETED');
...
CREATE TABLE "Shipment" (
    "id" TEXT NOT NULL,
    "orderId" TEXT NOT NULL,
    "method" TEXT NOT NULL DEFAULT 'Speed Post',
    "trackingNumber" TEXT,
...
-- CreateIndex
CREATE INDEX "ShippingRate_minWeight_idx" ON "ShippingRate"("minWeight");
